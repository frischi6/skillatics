...
const footerText =
    """Nachher: link privacy policy etc..! Don't forget to add your subscription terms and conditions. 
...
const appleApiKey = 'appl_epDEoQNbrEjBoSpPdaEBqgcOmrS';

//TO DO: add the Google API key for your app from the RevenueCat dashboard: https://app.revenuecat.com
const googleApiKey = 'goog_maDLwFRTTfOqTZAKTZbeWtDttsf';
